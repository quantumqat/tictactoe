...
public class TicTacToe {
    ...
    public static void main(String[] args){
        ...
        while (true) {
            ...
            pushPos(gameBoard, playerPos, "player");
    ...
    public static void pushPos(char[][] gameBoard, int pos, String user){
